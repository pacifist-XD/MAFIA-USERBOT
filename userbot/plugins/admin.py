...
async def promote(promt):
    ...
    try:
        ...
        await mafiaevent.edit(
            "`Promoted Successfully!` Promoted By [𝕄𝔸𝔽𝕀𝔸 𝕌𝕊𝔼ℝ𝔹𝕆𝕋](https://t.me/MAFIA_USERBOT)"
        )
...
async def demote(dmod):
    ...
    try:
        ...
        return
    await mafiaevent.edit(
        "`Demoted retard Successfully!` Promoted By [𝕄𝔸𝔽𝕀𝔸 𝕌𝕊𝔼ℝ𝔹𝕆𝕋](https://t.me/MAFIA_USERBOT)"
    )
    if BOTLOG:
